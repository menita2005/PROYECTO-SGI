...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.1/dist/js/bootstrap.bundle.min.js" integrity="sha384-HwwvtgBNo3bZJJLYd8oVXjrBZt8cqVSpeBNS5n7C8IVInixGAoxmnlMuBnhbgrkm" crossorigin="anonymous"></script>
    ...
    <nav  >
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item"><a class="nav-link active"href="../claseProducto/index.php">PRODUCTOS</a></li>
            <li class="nav-item"><a class="nav-link active"href="../claseCategoria/index.php">CATEGORIA</a></li>
            <li class="nav-item"><a class="nav-link active" href="?cargar=crear">Registrar Proveedor</a></li>
